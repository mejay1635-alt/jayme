...
`}this.pre.innerHTML=i}}dispose(){document.removeEventListener(`mousemove`,this.onMouseMove)}},zc=class{constructor(e,{fontSize:t=200,fontFamily:n=`Arial`,color:r=`#fdf9f3`}={}){this.canvas=document.createElement(`canvas`),this.context=this.canvas.getContext(`2d`),this.txt=e,this.fontSize=t,this.fontFamily=n,this.color=r,this.font=`600 ${this.fontSize}px ${this.fontFamily}`}resize(){this.context.font=this.font;let e=this.context.measureText(this.txt),t=Math.ceil(e.width)+20,n=Math.ceil(e.actualBoundingBoxAscent+e.actualBoundingBoxDescent)+20;this.canvas.width=t,this.canvas.height=n}render(){this.context.clearRect(0,0,this.canvas.width,this.canvas.height),this.context.fillStyle=this.color,this.context.font=this.font;let e=10+this.context.measureText(this.txt).actualBoundingBoxAscent;this.context.fillText(this.txt,10,e)}get texture(){return this.canvas}},Bc=class{constructor({text:e,asciiFontSize:t,textFontSize:n,textColor:r,planeBaseHeight:i,enableWaves:a},o,s,c){this.textString=e,this.asciiFontSize=t,this.textFontSize=n,this.textColor=r,this.planeBaseHeight=i,this.container=o,this.width=s,this.height=c,this.enableWaves=a,this.camera=new Xi(45,this.width/this.height,1,1e3),this.camera.position.z=30,this.scene=new Pn,this.mouse={x:this.width/2,y:this.height/2},this.onMouseMove=this.onMouseMove.bind(this)}async init(){try{await document.fonts.load(`600 200px "IBM Plex Mono"`),await document.fonts.load(`500 12px "IBM Plex Mono"`)}catch{}await document.fonts.ready,this.setMesh(),this.setRenderer()}setMesh(){this.textCanvas=new zc(this.textString,{fontSize:this.textFontSize,fontFamily:`IBM Plex Mono`,color:this.textColor}),this.textCanvas.resize(),this.textCanvas.render(),this.texture=new ui(this.textCanvas.texture),this.texture.minFilter=S;let e=this.textCanvas.canvas.width/this.textCanvas.canvas.height,t=this.planeBaseHeight,n=t*e,r=t;this.geometry=new hi(n,r,36,36),this.material=new wi({vertexShader:Pc,fragmentShader:Fc,transparent:!0,uniforms:{uTime:{value:0},mouse:{value:1},uTexture:{value:this.texture},uEnableWaves:{value:+!!this.enableWaves}}}),this.mesh=new Zr(this.geometry,this.material),this.scene.add(this.mesh)}setRenderer(){this.renderer=new jc({antialias:!1,alpha:!0}),this.renderer.setPixelRatio(1),this.renderer.setClearColor(0,0),this.filter=new Rc(this.renderer,{fontFamily:`IBM Plex Mono`,fontSize:this.asciiFontSize,invert:!0}),this.container.appendChild(this.filter.domElement),this.setSize(this.width,this.height),this.container.addEventListener(`mousemove`,this.onMouseMove),this.container.addEventListener(`touchmove`,this.onMouseMove)}setSize(e,t){this.width=e,this.height=t,this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.filter.setSize(e,t),this.center={x:e/2,y:t/2}}load(){this.animate()}onMouseMove(e){let t=e.touches?e.touches[0]:e,n=this.container.getBoundingClientRect(),r=t.clientX-n.left,i=t.clientY-n.top;this.mouse={x:r,y:i}}animate(){let e=()=>{this.animationFrameId=requestAnimationFrame(e),this.render()};e()}render(){let e=new Date().getTime()*.001;this.textCanvas.render(),this.texture.needsUpdate=!0,this.mesh.material.uniforms.uTime.value=Math.sin(e),this.updateRotation(),this.filter.render(this.scene,this.camera)}updateRotation(){let e=Ic(this.mouse.y,0,this.height,.5,-.5),t=Ic(this.mouse.x,0,this.width,-.5,.5);this.mesh.rotation.x+=(e-this.mesh.rotation.x)*.05,this.mesh.rotation.y+=(t-this.mesh.rotation.y)*.05}clear(){this.scene.traverse(e=>{e.isMesh&&typeof e.material==`object`&&e.material!==null&&(Object.keys(e.material).forEach(t=>{let n=e.material[t];typeof n==`object`&&n&&typeof n.dispose==`function`&&n.dispose()}),e.material.dispose(),e.geometry.dispose())}),this.scene.clear()}dispose(){cancelAnimationFrame(this.animationFrameId),this.filter&&(this.filter.dispose(),this.filter.domElement.parentNode&&this.container.removeChild(this.filter.domElement)),this.container.removeEventListener(`mousemove`,this.onMouseMove),this.container.removeEventListener(`touchmove`,this.onMouseMove),this.clear(),this.renderer&&(this.renderer.dispose(),this.renderer.forceContextLoss())}};function Vc({text:e=`David!`,asciiFontSize:t=8,textFontSize:n=200,textColor:r=`#fdf9f3`,planeBaseHeight:i=8,enableWaves:a=!0}){let o=(0,_.useRef)(null),s=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(!o.current)return;let c=!1,l=null,u=null,d=async(o,s,c)=>{let l=new Bc({text:e,asciiFontSize:t,textFontSize:n,textColor:r,planeBaseHeight:i,enableWaves:a},o,s,c);return await l.init(),l};return(async()=>{let{width:e,height:t}=o.current.getBoundingClientRect();if(e===0||t===0){l=new IntersectionObserver(async([e])=>{if(!c&&e.isIntersecting&&e.boundingClientRect.width>0&&e.boundingClientRect.height>0){let{width:t,height:n}=e.boundingClientRect;l.disconnect(),l=null,c||(s.current=await d(o.current,t,n),!c&&s.current&&s.current.load())}},{threshold:.1}),l.observe(o.current);return}s.current=await d(o.current,e,t),!c&&s.current&&(s.current.load(),u=new ResizeObserver(e=>{if(!e[0]||!s.current)return;let{width:t,height:n}=e[0].contentRect;t>0&&n>0&&s.current.setSize(t,n)}),u.observe(o.current))})(),()=>{c=!0,l&&l.disconnect(),u&&u.disconnect(),s.current&&=(s.current.dispose(),null)}},[e,t,n,r,i,a]),(0,Nc.jsx)(`div`,{ref:o,className:`ascii-text-container`,style:{position:`absolute`,width:`100%`,height:`100%`},children:(0,Nc.jsx)(`style`,{children:`
      ...
      `})})}function Hc(){return(0,Nc.jsx)(`main`,{className:`flex min-h-screen items-center justify-center overflow-hidden bg-black px-6`,children:(0,Nc.jsx)(`div`,{className:`relative h-[52vh] w-full max-w-6xl`,children:(0,Nc.jsx)(Vc,{text:`Jayme`,asciiFontSize:8,textFontSize:220,textColor:`#fdf9f3`,enableWaves:!0})})})}(0,v.createRoot)(document.getElementById(`root`)).render((0,Nc.jsx)(_.StrictMode,{children:(0,Nc.jsx)(Hc,{})}));